...
CatégorieTechnologieRôleFrontend mobileFlutter / DartInterface utilisateur multiplateforme (Android/iOS)Backend / APIFastAPI (Python)Traitement des requêtes et orchestration des modules IAVision par ordinateurDINOv2 (Meta AI)Reconnaissance et classification d'objetsOCRTesseract OCR / EasyOCRExtraction de texte à partir d'imagesTraductionDeep Translator / Google TranslateTraduction automatique FR / EN / ARSynthèse vocaleEdge TTSLecture vocale des résultats
